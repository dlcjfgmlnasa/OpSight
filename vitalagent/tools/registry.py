...
- FM tools 1–7 (FM-backed)        — vitalagent/tools/fm_tools.py
- EMR tools 8–12 (stub for now)   — vitalagent/tools/emr_tools_stub.py
...
from vitalagent.tools.emr_tools_stub import (
...
from vitalagent.tools.fm_tools import (
    tool_anomaly_score,
