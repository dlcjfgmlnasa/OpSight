...
[Assessment confidence] ← tool 3 + tool 4
...
[Limitations]        ← all tool quality_meta
```
...
1. Quote `overall_assessment` value **verbatim** (no paraphrase) — it already contains `[CLINICIAN-REVIEW: Group of Prof. Lee HC review required]` marker.
...
prescription. [CLINICIAN-REVIEW: Group of Prof. Lee HC review required]
